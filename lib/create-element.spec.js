...
test('create-element: not found', autoGlobals((t) => {
    const parent = create();
...
test('create-element: found: not uniq', autoGlobals((t, {querySelector}) => {
    const el = {};
...
test('create-element: notAppend', autoGlobals((t, {body}) => {
